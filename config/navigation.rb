...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    #
    primary.item :profile_link, 'Profile', '/' do |sub_nav|
...
#      sub_nav.item :key_2_1, 'name', '/', #options
#    end
...
#    primary.item :key_3, 'Admin', '/', class: 'special', if: -> { current_user.admin? }
#    primary.item :key_4, 'Account', '/', unless: -> { logged_in? }
